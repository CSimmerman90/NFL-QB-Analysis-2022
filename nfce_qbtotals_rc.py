...
data = pd.read_csv('nfc_e_qb_total_2021.csv')
...
# Get QB data
phi_data = get_qb_data(data_radar, 'PHI')
nyg_data = get_qb_data(data_radar, 'NYG')
dal_data = get_qb_data(data_radar, 'DAL')
was_data = get_qb_data(data_radar, 'WAS')
# Plot QB data
ax1 = create_radar_chart(ax1, angles, phi_data, team_colors['PHI'])
ax2 = create_radar_chart(ax2, angles, nyg_data, team_colors['NYG'])
ax3 = create_radar_chart(ax3, angles, dal_data, team_colors['DAL'])
ax4 = create_radar_chart(ax4, angles, was_data, team_colors['WAS'])
