...
data = pd.read_csv('afc_n_qb_total_2021.csv')
...
# Get QB data
cle_data = get_qb_data(data_radar, 'CLE')
cin_data = get_qb_data(data_radar, 'CIN')
bal_data = get_qb_data(data_radar, 'BAL')
pit_data = get_qb_data(data_radar, 'PIT')
# Plot QB data
ax1 = create_radar_chart(ax1, angles, cle_data, team_colors['CLE'])
ax2 = create_radar_chart(ax2, angles, cin_data, team_colors['CIN'])
ax3 = create_radar_chart(ax3, angles, bal_data, team_colors['BAL'])
ax4 = create_radar_chart(ax4, angles, pit_data, team_colors['PIT'])
